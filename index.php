	   ...
	   <table class="tbl-qa">
		  <thead>
                          ...
                          <tr> <th><a style="color:white" href="index.php<?php if ($monat==1) echo "?monat=12&jahr=".($jahr-1).'"'; 
                               ...
                               <th style="font-size: 30px; color: white;"><?php $dateObj   = DateTime::createFromFormat('!m', $monat); echo $dateObj->format('F'); echo " $jahr" ?> <a style="color:white" href="./index.php"> [Heute]</a></th>
