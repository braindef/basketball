...
<?php
 ...
 ?>
				...
				<td contenteditable="true" <?php if ($faq[$k]["id"] == "") echo "style=\"background-color:#ff0000;\""?> onBlur="saveToDatabase(this,'abends','<?php echo $faq[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $faq[$k]["abends"]; ?></td>
			  </tr>
