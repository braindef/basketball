...
<?php if (isset($_SESSION['user'])) echo "<font size=5em color=tomato>Eine Änderung an einem Feld wird gespeichert wenn man das Feld verlässt, d.H. in ein anderes Feld klickt. Mit Reload (F5) wird die Farbe angepasst bei den geänderten Felder.</font><br><font size=5em> Bitte nach dem Ausloggen die Einträge kontrollieren.</font><br>"; ?>
...
else
{
          ...
          echo '<a href=\'logout.php\'> Logout</a> <a href="./agenda.php">[Heute]</a> <a href="./log.php">[Änderungsprotokoll]</a>'; 
}
?>
	   <table class="tbl-qa">
		  <thead>
                          ...
                          <tr> <th><a style="color:white" href="agenda.php<?php if ($monat==1) echo "?monat=12&jahr=".($jahr-1).'"'; 
                               ...
                               <th><a style="color:white" href="agenda.php<?php if ($monat>11) echo "?monat=1&jahr=".($jahr+1).'"'; 
                                                           else echo "?monat=".($monat+1)."&jahr=".$jahr.'"'; ?>> 
                                     <?php $dateObj   = DateTime::createFromFormat('!m', $monat+1); echo $dateObj->format('F'); ?> ⇨</a></th>
